...
export const MetricCards: React.FC<MetricCardsProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 mb-3 text-center">
      {/* 1. Total Gross Fee */}
      <div className="bg-indigo-50/80 border border-indigo-200/80 p-2 rounded shadow-2xs">
      ...
      {/* 2. Concession / Waiver */}
      <div className="bg-emerald-50/80 border border-emerald-200/80 p-2 rounded shadow-2xs">
        <div className="flex items-center justify-between px-1">
      ...
      {/* 3. Paid to Date */}
      <div className="bg-blue-50/80 border border-blue-200/80 p-2 rounded shadow-2xs">
        <div className="flex items-center justify-between px-1">
      ...
      <div className="bg-amber-50/80 border border-amber-200/80 p-2 rounded shadow-2xs">
        <div className="flex items-center justify-between px-1">
      ...
      <div className="col-span-2 sm:col-span-1 bg-rose-50 border border-rose-200 p-2 rounded shadow-2xs">
        <div className="flex items-center justify-between px-1">
