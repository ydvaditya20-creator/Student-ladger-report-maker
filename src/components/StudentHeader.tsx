    ...
    <div className="w-full">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b-2 border-indigo-900 pb-3 mb-3 gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:text-right">
          <div className="hidden sm:block print:block mr-2 text-right">
            <span className="bg-indigo-900 text-white print:text-black print:bg-transparent print:border print:border-black px-2.5 py-1 rounded-xs text-[10px] font-bold tracking-widest uppercase inline-block">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 print:grid-cols-4 gap-3 print:gap-1.5 bg-white border border-slate-200 print:border-slate-800 p-3 print:p-1.5 rounded print:rounded-none shadow-2xs mb-3 print:mb-1.5">
        {/* Student Name */}
